  ...
  return (
    <div className='about'>
        <div className="about-left">
            <img src={aboutIcon} alt="" className='about-img' />
            <img src={playIcon} alt="" className='play-icon' onClick={()=>{setPlayVideo(true)}} />
        </div>
      <div className="about-right">
        ...
        empower students with the knowledge, skills, and experiences needed to excel in the 
        ...
        administrator, counselor, or educational leader, 
